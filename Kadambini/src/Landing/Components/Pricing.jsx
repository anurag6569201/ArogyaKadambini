    ...
    <>
      ...
      <Container fluid className="pricing-container mb-0 pb-0">
                ...
                <Col key={plan.key}>
                  ...
                  >
                    ...
                    <Card.Body>
                      ...
                      <Button href="#" className={`navbar-button-v1`}>
        ...
        <div className="container" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', position: 'relative' }}>
          <img height='300px' src={PricingImage} alt="" style={{ transform: 'scaleY(-1)' }} />
          <div class="blur" style={{ position: 'absolute', height: '100%', opacity: '.7', width: '100%' }}>
            <div class="gradient-mask" style={{ position: 'absolute', width: '100%', height: '80%' }}>
              <div class="spinning-gradient"></div>
            </div>
          </div>
                        ...
                        <tr key={feature.id}>
                          <td>
                            <div className="d-flex align-items-center">
                              <feature.icon size={18} className="me-2 flex-shrink-0" />
